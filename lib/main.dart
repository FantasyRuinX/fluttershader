    ...
    return MaterialApp(
      ...
      body: Column(children: [
        ...
        Slider(
            ...
            max: 5.0,
            divisions: 10,
            label: 'Time : ${(timeMagnitude * 10).round()}',
            onChanged: (double newValue) {
              timeMagnitude = newValue;
            }),
          Slider(
              value: fractal,
              min: 0.0,
